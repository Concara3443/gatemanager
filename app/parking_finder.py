...
_STANDARD_SCHENGEN = frozenset(
    {"schengen_only", "non_schengen_only", "mixed", "ga", "maintenance", "cargo"}
)
...
def filter_parkings(
    parkings, terminal, airline_code, wingspan, schengen_flight, occupied, dedicated_map=None
):
